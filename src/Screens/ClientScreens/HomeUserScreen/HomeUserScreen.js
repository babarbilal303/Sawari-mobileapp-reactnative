    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <Tabs tabBarUnderlineStyle={{ backgroundColor: ThemeColor.mainThmemColor }}  >
                ...
                <Tab heading={<TabHeading style={{ backgroundColor: '#ffffff' }}><Icon name="home" style={{ color: ThemeColor.mainThmemColor }} /><Text style={{ color: ThemeColor.mainThmemColor }}>Camera</Text></TabHeading>}>
                    <Text>babar`=2</Text>
                </Tab>
